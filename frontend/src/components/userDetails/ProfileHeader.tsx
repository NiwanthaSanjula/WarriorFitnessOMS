...
export const ProfileHeader = ({ user, isMember, onAssignClick }: ProfileHeaderProps ) => (
    <div className="bg-warrior-grey p-8 rounded-xl border border-neutral-600 flex flex-col md:flex-row gap-6 items-center border-l-3 border-l-warrior-orange">
