...
// FILE: src/pages/coach/WorkoutPlans.tsx
// This is the MAIN WORKOUT PLANS page for coaches
// Replace your Plans page with this for workout plans only
...
const WorkoutPlans = () => {
    ...
    // Fetch all workout plans on page load
    useEffect(() => {
        fetchWorkoutPlans();
    }, []);
    ...
    const fetchWorkoutPlans = async () => {
        try {
            setLoading(true);
            setError(null);
            const data = await planService.getWorkoutPlans();
    ...
    const handleDelete = async (planId: string) => {
        try {
            await planService.deleteWorkoutPlan(planId);
        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                <h2 className="text-lg md:text-2xl font-bold italic text-gray-400 uppercase">
                    Workout <span className="text-warrior-orange">Plans</span>
                </h2>
                <button
                    onClick={() => navigate('/coach/plans/workout/new')}
                        ...
                        >
                            ...
                            <div className="flex justify-between items-start">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        onClick={() => navigate(`/coach/plans/workout/${plan._id}/edit`)}
                            ...
                            <div className="grid grid-cols-2 gap-2 text-sm">
                                ...
                                <div>
                                    <p className="text-gray-500 font-bold">Frequency</p>
                                    <p className="text-white">{plan.daysPerWeek}x/week</p>
                                </div>
                                <div>
                                    <p className="text-gray-500 font-bold">Difficulty</p>
                                    <p className={`font-bold capitalize ${getDifficultyColor(plan.difficulty)}`}>
                                        {plan.difficulty}
                                    </p>
                                </div>
                                <div>
